...
class Index extends Base
{
    public function getRoutes()
    {
        $routes_arr = [
            ...
            [
                "path" => "/user/skillCert",
                "component" => "views/user/skillCert.html",
                "name" => "技能认证"
            ],
            [
                "path" => "/user/label",
                "component" => "views/user/label.html",
                "name" => "用户标签"
            ],
            [
                "path" => "/user/message",
            ...
            [
                "path" => "/skill/list",
                "component" => "views/skill/list.html",
                "name" => "陪玩服务"
            ],
            [
                "path" => "/skill/paragraphList",
                "component" => "views/skill/paragraphList.html",
                "name" => "段位信息"
            ],
            [
                "path" => "/skill/largeareaList",
                "component" => "views/skill/largeareaList.html",
                "name" => "大区信息"
            ],
            [
                "path" => "/skill/labelList",
                "component" => "views/skill/labelList.html",
                "name" => "标签信息"
            ],
            [
                "path" => "/order/list",
            ...
            [
                "path" => "/skill/unit",
                "component" => "views/skill/unit.html",
                "name" => "服务单元"
            ],
            [
                "path" => '/feedback/index',
                'component' => 'views/feedback/index.html',
                "name" => '意见反馈'
            ],
            [
                "path" => '/order/withdraw',
                'component' => 'views/order/withdraw.html',
                'name' => '订单提现'
            ]
        ];
