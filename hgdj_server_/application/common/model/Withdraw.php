...
class Withdraw extends Model
{
    ...
    //status字段:{{id:status_value,desc:status_description,timestamp:(int)timestamp}}
    ...
    public function scopeOfFinalStatus($query, $status)
    {
        if (!key_exists($status, self::WITHDRAW_STATUS)) {
            return $query;
        }
