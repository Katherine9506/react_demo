<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:65:"E:\repository\lanbabastory\/themes/admin/audio_category\save.html";i:1543282577;s:50:"E:\repository\lanbabastory\/themes/admin/base.html";i:1543373157;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
...
<div class="layui-body">
    ...
    <div class="layui-tab layui-tab-brief">
        <ul class="layui-tab-title">
            <li class=""><a href="<?php echo url('admin/audio_category/index'); ?>">音频分类</a></li>
            <li class="layui-this">
        ...
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
                <?php if(request()->action() == "add"): ?>
                <form class="layui-form form-container" action="<?php echo url('admin/audio_category/add'); ?>" method="post">
                <?php else: ?>
                <form class="layui-form form-container" action="<?php echo url('admin/audio_category/edit'); ?>" method="post">
