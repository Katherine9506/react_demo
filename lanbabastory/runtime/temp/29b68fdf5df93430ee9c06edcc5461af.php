<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:84:"/home/deepin/Projects/php/waibao/Child-Music//themes/admin/audio_category/index.html";i:1543199284;s:68:"/home/deepin/Projects/php/waibao/Child-Music//themes/admin/base.html";i:1543024942;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
...
<div class="layui-body">
    ...
    <div class="layui-tab layui-tab-brief">
        <ul class="layui-tab-title">
            <li class="layui-this">音频分类</li>
            <li class=""><a href="<?php echo url('admin/audio_category/add'); ?>">添加分类</a></li>
        </ul>
                ...
                <table class="layui-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo url('admin/audio_category/edit', ['id' => $item['id']]); ?>" class="layui-btn layui-btn-normal layui-btn-mini">编辑</a>
                                <a href="<?php echo url('admin/audio_category/del', ['id' => $item['id']]); ?>" class="layui-btn layui-btn-danger layui-btn-mini ajax-delete">删除</a>
                            </td>
                        </tr>
                        <?php endforeach; else: ?>
                        <tr>
