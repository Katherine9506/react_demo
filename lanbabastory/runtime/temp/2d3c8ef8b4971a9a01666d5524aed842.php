<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"/home/deepin/Projects/php/waibao/Child-Music//themes/admin/audio/index.html";i:1543225954;s:68:"/home/deepin/Projects/php/waibao/Child-Music//themes/admin/base.html";i:1543024942;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
                ...
                <table class="layui-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo url('admin/audio/edit', ['id' => $item['id']]); ?>" class="layui-btn layui-btn-normal layui-btn-mini">编辑</a>
                                <a href="<?php echo url('admin/audio/del', ['id' => $item['id']]); ?>" class="layui-btn layui-btn-danger layui-btn-mini ajax-delete">删除</a>
                            </td>
                        </tr>
                        <?php endforeach; else: ?>
                        <tr>
