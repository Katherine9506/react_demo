<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:57:"E:\repository\lanbabastory\/themes/admin/album\index.html";i:1543376269;s:50:"E:\repository\lanbabastory\/themes/admin/base.html";i:1543373157;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
            ...
            <div class="layui-tab-item layui-show">
                <table class="layui-table">
                    ...
                    <tr>
                        ...
                        <td width="80">
                            <a href="<?php echo url('admin/album/edit', ['id' => $item['id']]); ?>"
                               class="layui-btn layui-btn-normal layui-btn-mini">编辑</a>
                            <a href="<?php echo url('admin/album/del', ['id' => $item['id']]); ?>"
                               class="layui-btn layui-btn-danger layui-btn-mini ajax-delete">删除</a>
                            <a href="<?php echo url('admin/album/audios',['id' => $item['id']]); ?>"
