<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:56:"E:\repository\lanbabastory\/themes/admin/album\save.html";i:1543568766;s:50:"E:\repository\lanbabastory\/themes/admin/base.html";i:1543373157;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
...
<div class="layui-body">
    ...
    <div class="layui-tab layui-tab-brief">
        <ul class="layui-tab-title">
            <li class=""><a href="<?php echo url('admin/album/index'); ?>">专辑列表</a></li>
            <li class="layui-this">
        ...
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
                <?php if(request()->action() == "add"): ?>
                <form class="layui-form form-container" action="<?php echo url('admin/album/add'); ?>" method="post">
                    <?php else: ?>
                    <form class="layui-form form-container" action="<?php echo url('admin/album/edit'); ?>" method="post">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <select class="layui-select" name="cid" lay-verify="required">
                                    ...
                                    <?php foreach($category as $cid => $cv): ?>
                                    <option value="<?php echo $cid; ?>" <?php if(isset($detail[
                                    'cid']) && $detail['cid'] == $cid): ?>selected='true'<?php endif; ?>><?php echo $cv; ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="banner" value="<?php echo (isset($detail['banner']) && ($detail['banner'] !== '')?$detail['banner']:''); ?>" required
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <textarea name="introduce" required lay-verify="required" placeholder="专辑描述"
                                          class="layui-textarea"><?php echo (isset($detail['introduce']) && ($detail['introduce'] !== '')?$detail['introduce']:''); ?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                ...
                                <input type="checkbox" name="tags[]" value="<?php echo $tid; ?>"
                                       title="<?php echo $tag['title']; ?>" lay-skin="primary" required lay-verify="required" <?php if(isset($selected_tags) && in_array($tid, $selected_tags)): ?>checked<?php endif; ?>>
                                <?php endforeach; ?>
                            </div>
                        </div>
