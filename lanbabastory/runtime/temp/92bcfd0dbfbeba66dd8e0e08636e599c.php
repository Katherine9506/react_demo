<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:61:"E:\repository\lanbabastory\/themes/admin/album_tags\save.html";i:1543282577;s:50:"E:\repository\lanbabastory\/themes/admin/base.html";i:1543373157;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
...
<div class="layui-body">
    ...
    <div class="layui-tab layui-tab-brief">
        <ul class="layui-tab-title">
            <li class=""><a href="<?php echo url('admin/album_tags/index'); ?>">专辑标签</a></li>
            <li class="layui-this">
        ...
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
                <?php if(request()->action() == "add"): ?>
                <form class="layui-form form-container" action="<?php echo url('admin/album_tags/add'); ?>" method="post">
                <?php else: ?>
                <form class="layui-form form-container" action="<?php echo url('admin/album_tags/edit'); ?>" method="post">
                ...
                <?php endif; ?>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="image" value="<?php echo (isset($detail['image']) && ($detail['image'] !== '')?$detail['image']:''); ?>" required lay-verify="required" placeholder="请上传图标" class="layui-input layui-input-inline" id="thumb">
