<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:74:"/home/deepin/Projects/php/waibao/Child-Music//themes/admin/audio/save.html";i:1543226159;s:68:"/home/deepin/Projects/php/waibao/Child-Music//themes/admin/base.html";i:1543024942;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
                ...
                <?php endif; ?>
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="title" value="<?php echo (isset($detail['title']) && ($detail['title'] !== '')?$detail['title']:''); ?>" required lay-verify="required" placeholder="请输入音频名称名称" class="layui-input">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="thumb" value="<?php echo (isset($detail['thumb']) && ($detail['thumb'] !== '')?$detail['thumb']:''); ?>" required lay-verify="required" placeholder="请上传音频封面" class="layui-input layui-input-inline">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="audio" value="<?php echo (isset($detail['audio']) && ($detail['audio'] !== '')?$detail['audio']:''); ?>" required lay-verify="required" placeholder="请上传MP3音频文件" class="layui-input layui-input-inline">
                            <input type="file" name="file" class="layui-upload-file">
                        </div>
                    </div>

                    <div class="layui-form-item">
                        <label class="layui-form-label">音频介绍</label>
                        <div class="layui-input-block">
                            <input type="text" name="breif" value="<?php echo (isset($detail['breif']) && ($detail['breif'] !== '')?$detail['breif']:''); ?>" required lay-verify="required" placeholder="音频介绍(20字以内)" class="layui-input layui-input-inline">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            ...
                            <input type="radio" name="is_vip" value="<?php echo $k; ?>" title="<?php echo $v; ?>" <?php if((!isset($detail['is_vip']) && $k==0) || (isset($detail['is_vip']) && $detail['is_vip'] == $k)): ?>checked="true"<?php endif; ?>>
                            <?php endforeach; ?>
                        </div>
                    </div>
