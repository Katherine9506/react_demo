<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"/home/deepin/Projects/php/waibao/Child-Music//themes/admin/login/index.html";i:1543024954;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<body class="login">
<div class="login-title">蓝爸爸讲故事</div>
<form class="layui-form login-form" action="<?php echo url('admin/login/login'); ?>" method="post">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <?php $img = url("login/image");?>
            <img src="<?php echo $img; ?>" alt="点击更换" title="点击更换" onclick="this.src='<?php echo $img; ?>?time='+Math.random()" class="captcha">
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-input-block">
