<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"/home/deepin/Projects/php/waibao/Child-Music//themes/admin/album_tags/index.html";i:1543204003;s:68:"/home/deepin/Projects/php/waibao/Child-Music//themes/admin/base.html";i:1543024942;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
...
<div class="layui-body">
    ...
    <div class="layui-tab layui-tab-brief">
        <ul class="layui-tab-title">
            ...
            <li class=""><a href="<?php echo url('admin/album_tags/add'); ?>">添加标签</a></li>
        </ul>
                ...
                <table class="layui-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><img src="<?php echo $item['image']; ?>" width="40" height="40"/></td>
                            <td><?php echo $item["sort"]; ?></td>
                            <td><?php echo $statusList[$item["status"]]; ?></td>
                            <td>
                                <a href="<?php echo url('admin/album_tags/edit', ['id' => $item['id']]); ?>" class="layui-btn layui-btn-normal layui-btn-mini">编辑</a>
                                <a href="<?php echo url('admin/album_tags/del', ['id' => $item['id']]); ?>" class="layui-btn layui-btn-danger layui-btn-mini ajax-delete">删除</a>
                            </td>
                        </tr>
                        <?php endforeach; else: ?>
                        <tr>
